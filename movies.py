...
def moviesStories():
    ...
    moviesStories = {
            ...
            "nightmare_on_elm_street": (
                "\nA " + noun_movies + " on " + silly_word_movies +
                ...
                + girls_name_movies + " shares her " + noun_movies +
                "  with her friends, Nancy, Rod, and Glen.\n"
                "They've all been having similar " + noun_movies +
                ". That night, " + girls_name_movies + " is "
                + verb_ed_movies + " in her dream, and her "
                ...
                " her friends and face Freddy " + surname_movies +
                ".\nShe sets traps and brings him into the real world.\nShe "
                + verb_s_movies + " him, and her " + noun9_movies +
                " weakens him. Nancy defeats Freddy, and all seems well."
                "\nHowever, in the end, a " + adjective_movies +
                " twist suggests that Freddy's presence still lingers.\n")
        }
