...
def foodStories():
    ...
    ingredient_food = get_non_empty_input("Enter an Ingredient: ")
    ...
    foodStories = {
        "guacamole_food": (
            ...
            "...\nInstructions:\n"
            "Cut the avocados in half, " + verb_food +
            " the pit, and scoop the flesh into a " + noun_food + "\n"
            "Mash the avocados with a fork until you reach "
            "your desired consistency (some prefer " + adjective_food +
            ", while others like it " + adjective1_food + ").\n"
            "Add the diced " + ingredient_food + ", minced "
            + ingredient1_food + ", and diced " + ingredient2_food + ".\n"
            "Squeeze the lime juice over the mixture and season with "
            + condiment_food + " and pepper.\n"
            "Mix everything together and serve with " + noun1_food +
